...
namespace App\Entity\DiscountCode;
...
class DiscountCode
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity=Merchant::class, inversedBy="discountCodes")
    ...
    /**
     * @ORM\ManyToMany(targetEntity=Category::class, inversedBy="discountCodes")
     */
    private $categories;
